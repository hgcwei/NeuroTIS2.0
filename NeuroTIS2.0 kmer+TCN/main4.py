...
x_test,y_test = data_gen_final('human.test_kmer64.csv','human.test_label64.csv',2000)
...
def run_task():
    ...
    #
    # model.load_weights('tcn.fea.64.fil.10.ker.20.dil.124.nb.1.len.8000.weights')
