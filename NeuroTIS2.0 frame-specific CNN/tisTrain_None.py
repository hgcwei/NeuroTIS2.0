...
def get_tfr_ls(type):
    train_tfrecords_ls = ['tfrecs/' + type + '/train0.tfrec', 'tfrecs/' + type + '/train1.tfrec',
                          'tfrecs/' + type + '/train2.tfrec', 'tfrecs/' + type + '/train3.tfrec']

    test_tfrecords_ls = ['tfrecs/' + type + '/test.tfrec']

    return train_tfrecords_ls,test_tfrecords_ls
...
# train_tfrecords_ls0, test_tfrecords_ls0 = get_tfr_ls('0')
# train_tfrecords_ls1, test_tfrecords_ls1 = get_tfr_ls('1')
# train_tfrecords_ls2, test_tfrecords_ls2 = get_tfr_ls('2')
#
# test_tfrecords_ls = test_tfrecords_ls0 + test_tfrecords_ls1 + test_tfrecords_ls2
# train_tfrecords_ls = train_tfrecords_ls0 + train_tfrecords_ls1 + train_tfrecords_ls2

# type0 = '0'
#
# train_tfrecords_ls0 = ['tfrecs/'+type0+'/t0.tp.' +type0 + '.np.1.0.tfrec','tfrecs/'+type0+'/t1.tp.' +type0 + '.np.1.0.tfrec','tfrecs/'+type0+'/t2.tp.' +type0 + '.np.1.0.tfrec']
#
# test_tfrecords_ls0 = ['tfrecs/'+type0+'/t3.tp.' +type0 + '.np.1.0.tfrec']
#
# type1 = '1'
#
# train_tfrecords_ls1 = ['tfrecs/'+type1+'/t0.tp.' +type1 + '.np.1.0.tfrec','tfrecs/'+type1+'/t1.tp.' +type1 + '.np.1.0.tfrec','tfrecs/'+type1+'/t2.tp.' +type1 + '.np.1.0.tfrec']
#
# test_tfrecords_ls1 = ['tfrecs/'+type1+'/t3.tp.' +type1 + '.np.1.0.tfrec']
#
# type2 = '2'
#
# train_tfrecords_ls2 = ['tfrecs/'+type2+'/t0.tp.' +type2 + '.np.1.0.tfrec','tfrecs/'+type2+'/t1.tp.' +type2 + '.np.1.0.tfrec','tfrecs/'+type2+'/t2.tp.' +type2 + '.np.1.0.tfrec']
#
# test_tfrecords_ls2 = ['tfrecs/'+type2+'/t3.tp.' +type2 + '.np.1.0.tfrec']
#
# train_tfrecords_ls = train_tfrecords_ls0 + train_tfrecords_ls1 + train_tfrecords_ls2
#
# test_tfrecords_ls = test_tfrecords_ls0 + test_tfrecords_ls1 + test_tfrecords_ls2

train_tfrecords_ls = ['tfrecs/human/0/t0.tp.0.np.1.0.tfrec','tfrecs/human/1/t0.tp.1.np.1.0.tfrec','tfrecs/human/2/t0.tp.2.np.1.0.tfrec',
                      'tfrecs/human/0/t1.tp.0.np.1.0.tfrec','tfrecs/human/1/t1.tp.1.np.1.0.tfrec','tfrecs/human/2/t1.tp.2.np.1.0.tfrec',
                      'tfrecs/human/0/t2.tp.0.np.1.0.tfrec','tfrecs/human/1/t2.tp.1.np.1.0.tfrec','tfrecs/human/2/t2.tp.2.np.1.0.tfrec',
                      'tfrecs/human/0/t3.tp.0.np.1.0.tfrec','tfrecs/human/1/t3.tp.1.np.1.0.tfrec','tfrecs/human/2/t3.tp.2.np.1.0.tfrec']
test_tfrecords_ls = ['tfrecs/human/0/t4.tp.0.np.1.0.tfrec','tfrecs/human/1/t4.tp.1.np.1.0.tfrec','tfrecs/human/2/t4.tp.2.np.1.0.tfrec']

# train_tfrecords_ls = ['tfrecs/NeuroTIS/t0.tp.None.np.1.0.human.tfrec','tfrecs/NeuroTIS/t1.tp.None.np.1.0.human.tfrec','tfrecs/NeuroTIS/t2.tp.None.np.1.0.human.tfrec','tfrecs/NeuroTIS/t3.tp.None.np.1.0.human.tfrec']
# test_tfrecords_ls = ['tfrecs/NeuroTIS/t4.tp.None.np.1.0.human.tfrec']
...
with tf.Session() as sess:
    ...
    saver.save(sess, './model/None/neurotis.tis.model')
    coord.request_stop()
    coord.join(threads)